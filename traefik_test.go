...
func TestNoLocalService(t *testing.T) {
	out := catchStdOut(t, func() {
		GenerateTraefikToml([]string{"cloudbreakURL", "periscopeURL", "consumptionURL", "datalakeURL", "environmentURL", "redbeamsURL", "freeIpaURL", "thunderheadMockURL", "clusterProxyURL", "environments2ApiURL", "datalakeApiURL", "distroxApiURL", "recipesApiURL", "JAEGER_HOST", ""})
	})
	if len(out) > 0 {
...
func TestCloudbreakLocalService(t *testing.T) {
	out := catchStdOut(t, func() {
		GenerateTraefikToml([]string{"cloudbreakURL", "periscopeURL", "consumptionURL", "datalakeURL", "environmentURL", "redbeamsURL", "freeIpaURL", "thunderheadURL", "clusterProxyURL", "environments2ApiURL", "datalakeApiURL", "distroxApiURL", "recipesApiURL", "JAEGER_HOST", "cloudbreak"})
	})
...
func TestMultiLocalService(t *testing.T) {
	out := catchStdOut(t, func() {
		GenerateTraefikToml([]string{"cloudbreakURL", "periscopeURL", "consumptionURL", "datalakeURL", "environmentURL", "redbeamsURL", "freeIpaURL", "thunderheadURL", "clusterProxyURL", "environments2ApiURL", "datalakeApiURL", "distroxApiURL", "recipesApiURL", "JAEGER_HOST", "cloudbreak,periscope,datalake-api,environment,redbeams,freeipa,consumption"})
	})
