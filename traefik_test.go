...
func TestNoLocalService(t *testing.T) {
	out := catchStdOut(t, func() {
		GenerateTraefikToml([]string{"cloudbreakURL", "periscopeURL", "datalakeURL", "environmentURL", "redbeamsURL", "freeIpaURL", "caasURL", "clusterProxyURL", "environments2ApiURL", "datalakeApiURL", "distroxApiURL", "iamApiUrl", ""})
	})
	if len(out) > 0 {
...
func TestCloudbreakLocalService(t *testing.T) {
	out := catchStdOut(t, func() {
		GenerateTraefikToml([]string{"cloudbreakURL", "periscopeURL", "datalakeURL", "environmentURL", "redbeamsURL", "freeIpaURL", "caasURL", "clusterProxyURL", "environments2ApiURL", "datalakeApiURL", "distroxApiURL", "iamApiUrl", "cloudbreak"})
	})
...
func TestMultiLocalService(t *testing.T) {
	out := catchStdOut(t, func() {
		GenerateTraefikToml([]string{"cloudbreakURL", "periscopeURL", "datalakeURL", "environmentURL", "redbeamsURL", "freeIpaURL", "caasURL", "clusterProxyURL", "environments2ApiURL", "datalakeApiURL", "distroxApiURL", "iamApiUrl", "cloudbreak,periscope,datalake,environment,redbeams,freeipa"})
	})
