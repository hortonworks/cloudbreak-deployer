...
EOF
    ...
    cloudbreak:
        environment:
            ...
            - "CAAS_URL=$CAAS_URL"
            - "CB_SHOW_TERMINATED_CLUSTERS_ACTIVE=$CB_SHOW_TERMINATED_CLUSTERS_ACTIVE"
            - "CB_SHOW_TERMINATED_CLUSTERS_DAYS=$CB_SHOW_TERMINATED_CLUSTERS_DAYS"
            - "CB_SHOW_TERMINATED_CLUSTERS_HOURS=$CB_SHOW_TERMINATED_CLUSTERS_HOURS"
            - "CB_SHOW_TERMINATED_CLUSTERS_MINUTES=$CB_SHOW_TERMINATED_CLUSTERS_MINUTES"
