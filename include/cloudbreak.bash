...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 1.11.0-rc.6
    env-import DOCKER_TAG_CLOUDBREAK 1.11.0-rc.6
    env-import DOCKER_TAG_ULUWATU 1.11.0-rc.6
    env-import DOCKER_TAG_SULTANS 1.11.0-rc.6
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 1.11.0-rc.6
