...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_CAAS_MOCK 2.13.0-rc.85
    env-import DOCKER_TAG_PERISCOPE 2.13.0-rc.85
    env-import DOCKER_TAG_CLOUDBREAK 2.13.0-rc.85
    env-import DOCKER_TAG_DATALAKE 2.13.0-rc.85
    env-import DOCKER_TAG_REDBEAMS 2.13.0-rc.85
    env-import DOCKER_TAG_ENVIRONMENT 2.13.0-rc.85
    env-import DOCKER_TAG_FREEIPA 2.13.0-rc.85
    env-import DOCKER_TAG_ULUWATU 2.13.0-rc.85

    env-import DOCKER_TAG_IDBMMS 3054609db6e1133b4e9effaf8450f50632f34ace
    env-import DOCKER_TAG_ENVIRONMENTS2_API 3054609db6e1133b4e9effaf8450f50632f34ace
...
cloudbreak-conf-defaults() {
    ...
    # TODO placeholder CLUSTERPROXY_HOST
    env-import CLUSTERPROXY_HOST dummyhost.com
    ...
    # TODO placeholder CLUSTERPROXY_PORT
    env-import CLUSTERPROXY_PORT 12345
