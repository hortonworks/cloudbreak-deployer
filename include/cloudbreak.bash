...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_THUNDERHEAD_MOCK 2.49.0-b63
    env-import DOCKER_TAG_MOCK_INFRASTRUCTURE 2.49.0-b63
    env-import DOCKER_TAG_PERISCOPE 2.49.0-b63
    env-import DOCKER_TAG_CLOUDBREAK 2.49.0-b63
    env-import DOCKER_TAG_DATALAKE 2.49.0-b63
    env-import DOCKER_TAG_REDBEAMS 2.49.0-b63
    env-import DOCKER_TAG_ENVIRONMENT 2.49.0-b63
    env-import DOCKER_TAG_FREEIPA 2.49.0-b63
    env-import DOCKER_TAG_ULUWATU 2.49.0-b63
