...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_THUNDERHEAD_MOCK 2.67.0-b24
    env-import DOCKER_TAG_MOCK_INFRASTRUCTURE 2.67.0-b24
    env-import DOCKER_TAG_PERISCOPE 2.67.0-b24
    env-import DOCKER_TAG_CONSUMPTION 2.67.0-b24
    env-import DOCKER_TAG_CLOUDBREAK 2.67.0-b24
    env-import DOCKER_TAG_DATALAKE 2.67.0-b24
    env-import DOCKER_TAG_REDBEAMS 2.67.0-b24
    env-import DOCKER_TAG_ENVIRONMENT 2.67.0-b24
    env-import DOCKER_TAG_FREEIPA 2.67.0-b24
    env-import DOCKER_TAG_ULUWATU 2.67.0-b24
...
generate-toml-file-for-localdev-force() {
    ...
    generate-traefik-toml "$CLOUDBREAK_URL" "$PERISCOPE_URL" "$CONSUMPTION_URL" "$DATALAKE_URL" "$ENVIRONMENT_URL" "$REDBEAMS_URL" "$FREEIPA_URL" "http://$THUNDERHEAD_URL" "$CLUSTER_PROXY_URL" "$ENVIRONMENTS2_API_URL" "$DATALAKE_API_URL" "$DISTROX_API_URL" "" "$CB_LOCAL_DEV_LIST" > "$traefikFile"
}
