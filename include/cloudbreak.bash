...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 1.14.4-rc.7
    env-import DOCKER_TAG_CLOUDBREAK 1.14.4-rc.7
    env-import DOCKER_TAG_ULUWATU 1.14.4-rc.7
    env-import DOCKER_TAG_SULTANS 1.14.4-rc.7
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 1.14.4-rc.7
