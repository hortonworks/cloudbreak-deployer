...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_CAAS_MOCK 2.16.0-rc.56
    env-import DOCKER_TAG_PERISCOPE 2.16.0-rc.56
    env-import DOCKER_TAG_CLOUDBREAK 2.16.0-rc.56
    env-import DOCKER_TAG_DATALAKE 2.16.0-rc.56
    env-import DOCKER_TAG_REDBEAMS 2.16.0-rc.56
    env-import DOCKER_TAG_ENVIRONMENT 2.16.0-rc.56
    env-import DOCKER_TAG_FREEIPA 2.16.0-rc.56
    env-import DOCKER_TAG_ULUWATU 2.16.0-rc.56
