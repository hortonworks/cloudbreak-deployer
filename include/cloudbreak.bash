...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_REDBEAMS 2.26.0-b4
    env-import DOCKER_TAG_ENVIRONMENT 2.26.0-b4
    env-import DOCKER_TAG_FREEIPA 2.26.0-b4
    env-import DOCKER_TAG_ULUWATU 2.26.0-b4
