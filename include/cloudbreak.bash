...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_CAAS_MOCK to.1.0-dev.2
    env-import DOCKER_TAG_PERISCOPE to.1.0-dev.2
    env-import DOCKER_TAG_CLOUDBREAK to.1.0-dev.2
    env-import DOCKER_TAG_DATALAKE to.1.0-dev.2
    env-import DOCKER_TAG_REDBEAMS to.1.0-dev.2
    env-import DOCKER_TAG_ENVIRONMENT to.1.0-dev.2
    env-import DOCKER_TAG_FREEIPA to.1.0-dev.2
    env-import DOCKER_TAG_ULUWATU to.1.0-dev.2
