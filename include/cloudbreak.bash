...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_REDBEAMS 2.34.0-b2
    env-import DOCKER_TAG_ENVIRONMENT 2.34.0-b2
    env-import DOCKER_TAG_FREEIPA 2.34.0-b2
    env-import DOCKER_TAG_ULUWATU 2.34.0-b2
