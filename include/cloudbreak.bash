...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_THUNDERHEAD_MOCK 2.72.0-b62
    env-import DOCKER_TAG_MOCK_INFRASTRUCTURE 2.72.0-b62
    env-import DOCKER_TAG_PERISCOPE 2.72.0-b62
    env-import DOCKER_TAG_CONSUMPTION 2.72.0-b62
    env-import DOCKER_TAG_CLOUDBREAK 2.72.0-b62
    env-import DOCKER_TAG_DATALAKE 2.72.0-b62
    env-import DOCKER_TAG_REDBEAMS 2.72.0-b62
    env-import DOCKER_TAG_ENVIRONMENT 2.72.0-b62
    env-import DOCKER_TAG_FREEIPA 2.72.0-b62
    env-import DOCKER_TAG_ULUWATU 2.72.0-b62
