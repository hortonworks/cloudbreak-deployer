...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 1.2.4-rc.9
    env-import DOCKER_TAG_CLOUDBREAK 1.2.4-rc.9
    env-import DOCKER_TAG_ULUWATU 1.2.4-rc.9
    env-import DOCKER_TAG_SULTANS 1.2.4-rc.9
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 1.2.4-rc.9
