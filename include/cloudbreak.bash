...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE marci-teszt
    env-import DOCKER_TAG_CLOUDBREAK marci-teszt
    env-import DOCKER_TAG_ULUWATU marci-teszt
    env-import DOCKER_TAG_SULTANS marci-teszt
    env-import DOCKER_TAG_CLOUDBREAK_SHELL marci-teszt
