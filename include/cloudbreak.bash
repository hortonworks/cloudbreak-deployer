...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 2.0.1-rc.9
    env-import DOCKER_TAG_CLOUDBREAK 2.0.1-rc.9
    env-import DOCKER_TAG_ULUWATU 2.0.1-rc.9
    env-import DOCKER_TAG_SULTANS 2.0.1-rc.9
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 2.0.1-rc.9
