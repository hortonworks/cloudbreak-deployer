...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_CAAS_MOCK 2.25.0-b49
    env-import DOCKER_TAG_PERISCOPE 2.25.0-b49
    env-import DOCKER_TAG_CLOUDBREAK 2.25.0-b49
    env-import DOCKER_TAG_DATALAKE 2.25.0-b49
    env-import DOCKER_TAG_REDBEAMS 2.25.0-b49
    env-import DOCKER_TAG_ENVIRONMENT 2.25.0-b49
    env-import DOCKER_TAG_FREEIPA 2.25.0-b49
    env-import DOCKER_TAG_ULUWATU 2.25.0-b49
