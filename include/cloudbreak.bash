...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 1.13.0-rc.23
    env-import DOCKER_TAG_CLOUDBREAK 1.13.0-rc.23
    env-import DOCKER_TAG_ULUWATU 1.13.0-rc.23
    env-import DOCKER_TAG_SULTANS 1.13.0-rc.23
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 1.13.0-rc.23
