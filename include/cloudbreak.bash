...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 1.6.3-rc.3
    env-import DOCKER_TAG_CLOUDBREAK 1.6.3-rc.3
    env-import DOCKER_TAG_ULUWATU 1.6.3-rc.3
    env-import DOCKER_TAG_SULTANS 1.6.3-rc.3
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 1.6.3-rc.3
