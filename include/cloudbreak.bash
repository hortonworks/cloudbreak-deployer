...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_THUNDERHEAD_MOCK 2.73.0-b77
    env-import DOCKER_TAG_MOCK_INFRASTRUCTURE 2.73.0-b77
    env-import DOCKER_TAG_PERISCOPE 2.73.0-b77
    env-import DOCKER_TAG_CONSUMPTION 2.73.0-b77
    env-import DOCKER_TAG_CLOUDBREAK 2.73.0-b77
    env-import DOCKER_TAG_DATALAKE 2.73.0-b77
    env-import DOCKER_TAG_REDBEAMS 2.73.0-b77
    env-import DOCKER_TAG_ENVIRONMENT 2.73.0-b77
    env-import DOCKER_TAG_FREEIPA 2.73.0-b77
    env-import DOCKER_TAG_ULUWATU 2.73.0-b77

    env-import DOCKER_TAG_IDBMMS 1.0.0-b10711
    env-import DOCKER_TAG_WORKLOADIAM 1.0.0-b10711
    env-import DOCKER_TAG_ENVIRONMENTS2_API 1.0.0-b10711
    env-import DOCKER_TAG_DATALAKE_API 1.0.0-b10711
    env-import DOCKER_TAG_DISTROX_API 1.0.0-b10711
    env-import DOCKER_TAG_AUDIT 1.0.0-b10711
    env-import DOCKER_TAG_DATALAKE_DR 1.0.0-b10711
...
cloudbreak-conf-defaults() {
    ...
    env-import CDP_GW_VERSION "2.1.0-b254"
...
generate-toml-file-for-localdev-force() {
    ...
    generate-traefik-toml "$CLOUDBREAK_URL" "$PERISCOPE_URL" "$CONSUMPTION_URL" "$DATALAKE_URL" "$ENVIRONMENT_URL" "$REDBEAMS_URL" "$FREEIPA_URL" "http://$THUNDERHEAD_URL" "$CLUSTER_PROXY_URL" "$ENVIRONMENTS2_API_URL" "$DATALAKE_API_URL" "$DISTROX_API_URL" "$AUDIT_API_URL" "$CB_LOCAL_DEV_LIST" > "$traefikFile"
}
