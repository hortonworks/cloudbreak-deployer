...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 2.3.0-rc.5
    env-import DOCKER_TAG_CLOUDBREAK 2.3.0-rc.5
    env-import DOCKER_TAG_ULUWATU 2.3.0-rc.5
    env-import DOCKER_TAG_SULTANS 2.3.0-rc.5
