...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_CAAS_MOCK 2.17.0-rc.42
    env-import DOCKER_TAG_PERISCOPE 2.17.0-rc.42
    env-import DOCKER_TAG_CLOUDBREAK 2.17.0-rc.42
    env-import DOCKER_TAG_DATALAKE 2.17.0-rc.42
    env-import DOCKER_TAG_REDBEAMS 2.17.0-rc.42
    env-import DOCKER_TAG_ENVIRONMENT 2.17.0-rc.42
    env-import DOCKER_TAG_FREEIPA 2.17.0-rc.42
    env-import DOCKER_TAG_ULUWATU 2.17.0-rc.42
