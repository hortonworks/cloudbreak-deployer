...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 1.5.0-rc.1
    env-import DOCKER_TAG_CLOUDBREAK 1.5.0-rc.1
    env-import DOCKER_TAG_ULUWATU 1.5.0-rc.1
    env-import DOCKER_TAG_SULTANS 1.5.0-rc.1
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 1.5.0-rc.1
