...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_THUNDERHEAD_MOCK 2.41.0-b93
    env-import DOCKER_TAG_MOCK_INFRASTRUCTURE 2.41.0-b93
    env-import DOCKER_TAG_PERISCOPE 2.41.0-b93
    env-import DOCKER_TAG_CLOUDBREAK 2.41.0-b93
    env-import DOCKER_TAG_DATALAKE 2.41.0-b93
    env-import DOCKER_TAG_REDBEAMS 2.41.0-b93
    env-import DOCKER_TAG_ENVIRONMENT 2.41.0-b93
    env-import DOCKER_TAG_FREEIPA 2.41.0-b93
    env-import DOCKER_TAG_ULUWATU 2.41.0-b93
