...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_CAAS_MOCK 2.15.0-dev.44
    env-import DOCKER_TAG_PERISCOPE 2.15.0-dev.44
    env-import DOCKER_TAG_CLOUDBREAK 2.15.0-dev.44
    env-import DOCKER_TAG_DATALAKE 2.15.0-dev.44
    env-import DOCKER_TAG_REDBEAMS 2.15.0-dev.44
    env-import DOCKER_TAG_ENVIRONMENT 2.15.0-dev.44
    env-import DOCKER_TAG_FREEIPA 2.15.0-dev.44
    env-import DOCKER_TAG_ULUWATU 2.15.0-dev.44
