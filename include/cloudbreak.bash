...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 1.10.0-rc.10
    env-import DOCKER_TAG_CLOUDBREAK 1.10.0-rc.10
    env-import DOCKER_TAG_ULUWATU 1.10.0-rc.10
    env-import DOCKER_TAG_SULTANS 1.10.0-rc.10
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 1.10.0-rc.10
