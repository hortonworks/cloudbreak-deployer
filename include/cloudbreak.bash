...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 2.9.3-rc.10
    env-import DOCKER_TAG_CLOUDBREAK 2.9.3-rc.10
    env-import DOCKER_TAG_ULUWATU 2.9.3-rc.10
    env-import DOCKER_TAG_SULTANS 2.9.3-rc.10
