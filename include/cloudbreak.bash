...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 2.7.3-rc.82
    env-import DOCKER_TAG_CLOUDBREAK 2.7.3-rc.82
    env-import DOCKER_TAG_ULUWATU 2.7.3-rc.82
    env-import DOCKER_TAG_SULTANS 2.7.3-rc.82
