...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_THUNDERHEAD_MOCK 2.38.0-b5
    env-import DOCKER_TAG_MOCK_INFRASTRUCTURE 2.38.0-b5
    env-import DOCKER_TAG_PERISCOPE 2.38.0-b5
    env-import DOCKER_TAG_CLOUDBREAK 2.38.0-b5
    env-import DOCKER_TAG_DATALAKE 2.38.0-b5
    env-import DOCKER_TAG_REDBEAMS 2.38.0-b5
    env-import DOCKER_TAG_ENVIRONMENT 2.38.0-b5
    env-import DOCKER_TAG_FREEIPA 2.38.0-b5
    env-import DOCKER_TAG_ULUWATU 2.38.0-b5
