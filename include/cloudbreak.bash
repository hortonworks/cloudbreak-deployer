...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_CAAS_MOCK 2.23.0-b71
    env-import DOCKER_TAG_PERISCOPE 2.23.0-b71
    env-import DOCKER_TAG_CLOUDBREAK 2.23.0-b71
    env-import DOCKER_TAG_DATALAKE 2.23.0-b71
    env-import DOCKER_TAG_REDBEAMS 2.23.0-b71
    env-import DOCKER_TAG_ENVIRONMENT 2.23.0-b71
    env-import DOCKER_TAG_FREEIPA 2.23.0-b71
    env-import DOCKER_TAG_ULUWATU 2.23.0-b71
