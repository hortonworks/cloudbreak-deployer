...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_THUNDERHEAD_MOCK 2.28.0-b7
    env-import DOCKER_TAG_PERISCOPE 2.28.0-b7
    env-import DOCKER_TAG_CLOUDBREAK 2.28.0-b7
    env-import DOCKER_TAG_DATALAKE 2.28.0-b7
    env-import DOCKER_TAG_REDBEAMS 2.28.0-b7
    env-import DOCKER_TAG_ENVIRONMENT 2.28.0-b7
    env-import DOCKER_TAG_FREEIPA 2.28.0-b7
    env-import DOCKER_TAG_ULUWATU 2.28.0-b7
