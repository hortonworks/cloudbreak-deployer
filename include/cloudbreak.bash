...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_CAAS_MOCK 1.999.999-b2
    env-import DOCKER_TAG_PERISCOPE 1.999.999-b2
    env-import DOCKER_TAG_CLOUDBREAK 1.999.999-b2
    env-import DOCKER_TAG_DATALAKE 1.999.999-b2
    env-import DOCKER_TAG_REDBEAMS 1.999.999-b2
    env-import DOCKER_TAG_ENVIRONMENT 1.999.999-b2
    env-import DOCKER_TAG_FREEIPA 1.999.999-b2
    env-import DOCKER_TAG_ULUWATU 1.999.999-b2
