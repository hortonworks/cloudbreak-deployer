...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 2.1.0-rc.6
    env-import DOCKER_TAG_CLOUDBREAK 2.1.0-rc.6
    env-import DOCKER_TAG_ULUWATU 2.1.0-rc.6
    env-import DOCKER_TAG_SULTANS 2.1.0-rc.6
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 2.1.0-rc.6
