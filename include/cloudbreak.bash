...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_THUNDERHEAD_MOCK 2.53.0-b86
    env-import DOCKER_TAG_MOCK_INFRASTRUCTURE 2.53.0-b86
    env-import DOCKER_TAG_PERISCOPE 2.53.0-b86
    env-import DOCKER_TAG_CLOUDBREAK 2.53.0-b86
    env-import DOCKER_TAG_DATALAKE 2.53.0-b86
    env-import DOCKER_TAG_REDBEAMS 2.53.0-b86
    env-import DOCKER_TAG_ENVIRONMENT 2.53.0-b86
    env-import DOCKER_TAG_FREEIPA 2.53.0-b86
    env-import DOCKER_TAG_ULUWATU 2.53.0-b86
