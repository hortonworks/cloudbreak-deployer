...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_CAAS_MOCK 2.10.0-dev.777
    env-import DOCKER_TAG_PERISCOPE 2.10.0-dev.777
    env-import DOCKER_TAG_CLOUDBREAK 2.10.0-dev.777
    env-import DOCKER_TAG_DATALAKE 2.10.0-dev.777
    env-import DOCKER_TAG_ULUWATU 2.10.0-dev.777
