...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 2.4.1-rc.30
    env-import DOCKER_TAG_CLOUDBREAK 2.4.1-rc.30
    env-import DOCKER_TAG_ULUWATU 2.4.1-rc.30
    env-import DOCKER_TAG_SULTANS 2.4.1-rc.30
