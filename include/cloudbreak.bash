...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_THUNDERHEAD_MOCK 2.58.0-b17
    env-import DOCKER_TAG_MOCK_INFRASTRUCTURE 2.58.0-b17
    env-import DOCKER_TAG_PERISCOPE 2.58.0-b17
    env-import DOCKER_TAG_CONSUMPTION 2.58.0-b17
    env-import DOCKER_TAG_CLOUDBREAK 2.58.0-b17
    env-import DOCKER_TAG_DATALAKE 2.58.0-b17
    env-import DOCKER_TAG_REDBEAMS 2.58.0-b17
    env-import DOCKER_TAG_ENVIRONMENT 2.58.0-b17
    env-import DOCKER_TAG_FREEIPA 2.58.0-b17
    env-import DOCKER_TAG_ULUWATU 2.58.0-b17
