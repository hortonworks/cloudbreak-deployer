...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 2.10.0-dev.52
    env-import DOCKER_TAG_CLOUDBREAK 2.10.0-dev.52
    env-import DOCKER_TAG_ULUWATU 2.10.0-dev.52
    env-import DOCKER_TAG_SULTANS 2.10.0-dev.52
