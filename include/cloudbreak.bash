...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_THUNDERHEAD_MOCK 2.36.0-b53
    env-import DOCKER_TAG_MOCK_INFRASTRUCTURE 2.36.0-b53
    env-import DOCKER_TAG_PERISCOPE 2.36.0-b53
    env-import DOCKER_TAG_CLOUDBREAK 2.36.0-b53
    env-import DOCKER_TAG_DATALAKE 2.36.0-b53
    env-import DOCKER_TAG_REDBEAMS 2.36.0-b53
    env-import DOCKER_TAG_ENVIRONMENT 2.36.0-b53
    env-import DOCKER_TAG_FREEIPA 2.36.0-b53
    env-import DOCKER_TAG_ULUWATU 2.36.0-b53
